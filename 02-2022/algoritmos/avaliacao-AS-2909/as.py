#Faça um algoritmo que calcule o valor a ser pago de PIS, COFINS e Lucro de uma empresa
#com base no seu faturamento. A alíquota de PIS é de 0,65% e COFINS 3%, os custos de uma
